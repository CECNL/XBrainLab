...
class PreprocessPanel(PanelBase):
    def __init__(self, parent, **args):
        ...
        self.row_label = ["Avg trials per session: ", "EEG channels: ", "Highpass: ", "Lowpass: ", "Sampling rate: "]
        ...
        if preprocessed_data!= None:   
            ...
            if isinstance(preprocessed_data, Raw):
                ...
                for k in self.preprocessed_data.raw_events.keys():
                    ...
                    row_value[2] = float(self.preprocessed_data.mne_data[k].info['highpass'])
                    row_value[3] = float(self.preprocessed_data.mne_data[k].info['lowpass'])
