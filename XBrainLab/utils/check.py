...
def validate_type(instance: object, type_class: type|List[type], message_name: str) -> None:
    ...
    Args:
        ...
        type_class: Acceptable type(s) of the instance. Can be a single type or a tuple of types.
...
def validate_list_type(instance_list: list, type_class: type|List[type], message_name: str) -> None:
    ...
    Args:
        ...
        type_class: Acceptable type(s) of the instances. Can be a single type or a tuple of types.
        message_name: The name of the instances to be displayed in the error message.
    
    Raises:
        TypeError: If any instance in the list is not an instance of the acceptable type(s).
    """
